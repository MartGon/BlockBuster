...
Collisions::Ray Collisions::ScreenToWorldRay(const glm::mat4& projViewMat, glm::vec2 screenPos, glm::vec2 screenSize)
{
    ...
    auto screenToWorld = glm::inverse(projViewMat);
