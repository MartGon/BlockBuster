...
namespace Collisions
{
    ...
    AABBSlopeIntersection AABBSlopeCollision(glm::vec3 posA, glm::vec3 prevPosA, glm::vec3 sizeA, glm::vec3 sizeB, bool gravity, float graivitySpeed, float precision = 0.005f);
