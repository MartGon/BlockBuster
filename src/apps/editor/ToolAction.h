...
namespace BlockBuster
{
    namespace Editor
    {
        ...
        {
        public:
            PlaceBlockAction(glm::ivec3 pos, Game::Block block, std::vector<Game::Block>* blocks, Game::Map::Map* map) : 
        ...
        {
        public:
            RemoveAction(glm::ivec3 pos, Game::Block block, std::vector<Game::Block>* blocks, Game::Map::Map* map) : 
                pos_{pos}, block_{block}, blocks_{blocks}, map_{map} {}
        ...
        {
        public:
            PaintAction(glm::ivec3 pos, Game::Block* block, Game::Display display, std::vector<Game::Block>* blocks, Game::Map::Map* map) : 
        ...
        public:
            RotateAction(glm::ivec3 pos, Game::Block* block, glm::vec3 rotation, std::vector<Game::Block>* blocks, 
                Game::Map::Map* map, Game::BlockRot rot) :
